...
func (_Main *MainTransactor) MintNFT(opts *bind.TransactOpts, to common.Address, uri string) (*types.Transaction, error) {
	return _Main.contract.Transact(opts, "mintNFT", to, uri)
}

// MintNFT is a paid mutator transaction binding the contract method 0xeacabe14.
//
// Solidity: function mintNFT(address to, string uri) returns()
func (_Main *MainSession) MintNFT(to common.Address, uri string) (*types.Transaction, error) {
	return _Main.Contract.MintNFT(&_Main.TransactOpts, to, uri)
}

// MintNFT is a paid mutator transaction binding the contract method 0xeacabe14.
//
// Solidity: function mintNFT(address to, string uri) returns()
func (_Main *MainTransactorSession) MintNFT(to common.Address, uri string) (*types.Transaction, error) {
	return _Main.Contract.MintNFT(&_Main.TransactOpts, to, uri)
}
...
func (_Main *MainTransactor) SafeTransferFrom0(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Main.contract.Transact(opts, "safeTransferFrom0", from, to, tokenId, data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes data) returns()
func (_Main *MainSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Main.Contract.SafeTransferFrom0(&_Main.TransactOpts, from, to, tokenId, data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes data) returns()
func (_Main *MainTransactorSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Main.Contract.SafeTransferFrom0(&_Main.TransactOpts, from, to, tokenId, data)
}
...
// MainBatchMetadataUpdateIterator is returned from FilterBatchMetadataUpdate and is used to iterate over the raw logs and unpacked data for BatchMetadataUpdate events raised by the Main contract.
type MainBatchMetadataUpdateIterator struct {
	Event *MainBatchMetadataUpdate // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MainBatchMetadataUpdateIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MainBatchMetadataUpdate)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MainBatchMetadataUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MainBatchMetadataUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MainBatchMetadataUpdate represents a BatchMetadataUpdate event raised by the Main contract.
type MainBatchMetadataUpdate struct {
	FromTokenId *big.Int
	ToTokenId   *big.Int
	Raw         types.Log // Blockchain specific contextual infos
}
...
func (_Main *MainFilterer) FilterBatchMetadataUpdate(opts *bind.FilterOpts) (*MainBatchMetadataUpdateIterator, error) {

	logs, sub, err := _Main.contract.FilterLogs(opts, "BatchMetadataUpdate")
	if err != nil {
		return nil, err
	}
	return &MainBatchMetadataUpdateIterator{contract: _Main.contract, event: "BatchMetadataUpdate", logs: logs, sub: sub}, nil
}

// WatchBatchMetadataUpdate is a free log subscription operation binding the contract event 0x6bd5c950a8d8df17f772f5af37cb3655737899cbf903264b9795592da439661c.
//
// Solidity: event BatchMetadataUpdate(uint256 _fromTokenId, uint256 _toTokenId)
func (_Main *MainFilterer) WatchBatchMetadataUpdate(opts *bind.WatchOpts, sink chan<- *MainBatchMetadataUpdate) (event.Subscription, error) {

	logs, sub, err := _Main.contract.WatchLogs(opts, "BatchMetadataUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(MainBatchMetadataUpdate)
				if err := _Main.contract.UnpackLog(event, "BatchMetadataUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BatchMetadataUpdate(uint256 _fromTokenId, uint256 _toTokenId)
func (_Main *MainFilterer) ParseBatchMetadataUpdate(log types.Log) (*MainBatchMetadataUpdate, error) {
	event := new(MainBatchMetadataUpdate)
	if err := _Main.contract.UnpackLog(event, "BatchMetadataUpdate", log); err != nil {
		return nil, err
	}
...
// MainMetadataUpdateIterator is returned from FilterMetadataUpdate and is used to iterate over the raw logs and unpacked data for MetadataUpdate events raised by the Main contract.
type MainMetadataUpdateIterator struct {
	Event *MainMetadataUpdate // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MainMetadataUpdateIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MainMetadataUpdate)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MainMetadataUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MainMetadataUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MainMetadataUpdate represents a MetadataUpdate event raised by the Main contract.
type MainMetadataUpdate struct {
	TokenId *big.Int
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_Main *MainFilterer) FilterMetadataUpdate(opts *bind.FilterOpts) (*MainMetadataUpdateIterator, error) {

	logs, sub, err := _Main.contract.FilterLogs(opts, "MetadataUpdate")
	if err != nil {
		return nil, err
	}
	return &MainMetadataUpdateIterator{contract: _Main.contract, event: "MetadataUpdate", logs: logs, sub: sub}, nil
}

// WatchMetadataUpdate is a free log subscription operation binding the contract event 0xf8e1a15aba9398e019f0b49df1a4fde98ee17ae345cb5f6b5e2c27f5033e8ce7.
//
// Solidity: event MetadataUpdate(uint256 _tokenId)
func (_Main *MainFilterer) WatchMetadataUpdate(opts *bind.WatchOpts, sink chan<- *MainMetadataUpdate) (event.Subscription, error) {

	logs, sub, err := _Main.contract.WatchLogs(opts, "MetadataUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(MainMetadataUpdate)
				if err := _Main.contract.UnpackLog(event, "MetadataUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MetadataUpdate(uint256 _tokenId)
func (_Main *MainFilterer) ParseMetadataUpdate(log types.Log) (*MainMetadataUpdate, error) {
	event := new(MainMetadataUpdate)
	if err := _Main.contract.UnpackLog(event, "MetadataUpdate", log); err != nil {
		return nil, err
	}
